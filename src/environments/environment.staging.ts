...
export const environment = {
    ...
    // Website URL
    HomePageURL: 'https://xgame-homepage-ui.staginglab.info',
    MarketplaceURL: 'https://xgame-marketplace-ui.staginglab.info',
    DashboardURL: 'https://xgame-dashboard-ui.staginglab.info',
    ...
    // DotCo Website URL
    DotCoHomePageURL: 'https://xgame.co/',
    DotCoMarketplaceURL: 'https://nft.xgame.co/',
    DotCoDashboardURL: 'https://dashboard.xgame.co/',
    
    // DotCo API URL
    DotCoNFTAPIURL: "https://astrochibbi-nft-api.xgame.co",
    DotCoProductAPIURL: "https://product-page-api.xgame.co",
    DotCoLabelAPIURL: "https://labels-api.xgame.live",
    DotCoBlogAPIURL: "https://blogs-api.xgame.co",
  
    // DotAI Website URL
    DotAIHomePageURL: 'https://xgame.co/',
    DotAI: 'https://nft.xgame.co/',
    DotAIDashboardURL: 'https://dashboard.xgame.co/',
    // DotCo API URL
    DotAINFTAPIURL: "https://astrochibbi-nft-api.xgame.co",
    DotAIProductAPIURL: "https://product-page-api.xgame.co",
    DotAILabelAPIURL: "https://labels-api.xgame.live",
    DotAIBlogAPIURL: "https://blogs-api.xgame.co",
